...
// Cypress.Commands.add('login', (email, password) => { ... })
    ...
    Cypress.Commands.add('SetSttings', (setting,subSetting) => { 
        ...
        cy.get('.parent-menu > .ng-scrollbar > .ng-scrollbar-wrapper > .ng-scroll-viewport-wrapper > .ng-native-scrollbar-hider > .ng-scroll-content > ul > :nth-child(6) > .menu-item-name > span').contains(setting).click()
